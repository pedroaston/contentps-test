...
// test case.
func SetupNetwork(ctx context.Context, ri *DHTRunInfo, latency time.Duration, bandwidth int) error {
...
func Base(ctx context.Context, runenv *runtime.RunEnv, commonOpts *SetupOpts) (*DHTRunInfo, error) {
	...
	if err := SetupNetwork(ectx, ri, commonOpts.Latency, commonOpts.Bandwidth); err != nil {
		return nil, err
	}
